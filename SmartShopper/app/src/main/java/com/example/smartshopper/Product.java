...
public final class Product implements Serializable {
    ...
    public String simplifiedSearchName; // denotes simplified search name for search
    ...
    public Product(final String barcode, final String name, final String vendorName, final double price, final boolean hasAisle,
